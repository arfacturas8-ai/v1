...
describe('CommunitySettings', () => {
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      const { container } = render(<CommunitySettings {...defaultProps} />);
    ...
    it('handles loading state', () => {
      render(<CommunitySettings {...defaultProps} loading={true} />);
      // Check for loading indicators
    });

    it('handles error state', () => {
      const error = 'Test error';
      render(<CommunitySettings {...defaultProps} error={error} />);
  ...
  describe('User Interactions', () => {
    it('handles user interactions', async () => {
      ...
      render(<CommunitySettings {...defaultProps} onAction={handleAction} />);
  ...
  describe('Edge Cases', () => {
    it('handles null/undefined props gracefully', () => {
      ...
      expect(() => render(<CommunitySettings />)).not.toThrow();
    });
  });
});

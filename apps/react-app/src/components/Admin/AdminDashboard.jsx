      ...
      <div className="admin-tabs">
        {tabs.map(tab => {
          ...
          return (
            <button
              key={tab.id}
              className={`admin-tab ${activeTab === tab.id ? 'bg-gradient-to-r from-[#58a6ff] to-[#a371f7] text-white shadow-lg' : 'bg-[#21262d] text-[#8b949e] hover:bg-[#30363d] hover:text-white'}`}
            ...
            {activeTab === 'content' && (
              <div className="admin-content-mgmt">
                ...
                <div className="content-tabs">
                  ...
                  <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#21262d] text-[#8b949e] hover:bg-[#30363d] hover:text-white font-medium text-sm transition-all">Posts</button>
                  <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#21262d] text-[#8b949e] hover:bg-[#30363d] hover:text-white font-medium text-sm transition-all">Comments</button>
                  <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#21262d] text-[#8b949e] hover:bg-[#30363d] hover:text-white font-medium text-sm transition-all">Flagged</button>
                </div>
                  ...
                  <div className="settings-section">
                    ...
                    <div className="setting-item">
                      <label>
                        ...
                        <input type="text" defaultValue="CRYB" className="w-full px-4 py-2.5 bg-[#21262d] border border-white/10 rounded-lg text-white placeholder-[#8b949e] focus:outline-none focus:border-[#58a6ff] focus:ring-2 focus:ring-[#58a6ff]/20 transition-all" />
                      </label>
                    </div>
                    <div className="setting-item">
                      <label>
                  ...
                  <div className="settings-section">
                    ...
                    <div className="setting-item">
                      <label>
                        ...
                        <input type="number" defaultValue="10" min="1" max="100" className="w-full px-4 py-2.5 bg-[#21262d] border border-white/10 rounded-lg text-white placeholder-[#8b949e] focus:outline-none focus:border-[#58a6ff] focus:ring-2 focus:ring-[#58a6ff]/20 transition-all" />
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="settings-section">
                    ...
                    <div className="setting-item">
                      <label>
                        ...
                        <input type="number" defaultValue="30" min="5" max="1440" className="w-full px-4 py-2.5 bg-[#21262d] border border-white/10 rounded-lg text-white placeholder-[#8b949e] focus:outline-none focus:border-[#58a6ff] focus:ring-2 focus:ring-[#58a6ff]/20 transition-all" />
                      </label>
                    </div>
                  </div>
                </div>

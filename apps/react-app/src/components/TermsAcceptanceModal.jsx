      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl border border-[var(--border-subtle)] shadow-2xl overflow-hidden">
        <div className="p-6 sm:p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              onClick={onAccept}
              className="flex-1 px-6 py-2.5 bg-gradient-to-r from-[#58a6ff] to-[#a371f7] hover:from-[#4895ee] hover:to-[#9260e6] text-white rounded-lg font-medium transition-all min-h-[44px]"
            >
              Accept & Continue
            </button>
          </div>

...
describe('UserSearch', () => {
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      const { container } = render(<UserSearch {...defaultProps} />);
    ...
    it('handles loading state', () => {
      render(<UserSearch {...defaultProps} loading={true} />);
      // Check for loading indicators
    });

    it('handles error state', () => {
      const error = 'Test error';
      render(<UserSearch {...defaultProps} error={error} />);
  ...
  describe('User Interactions', () => {
    it('handles user interactions', async () => {
      ...
      render(<UserSearch {...defaultProps} onAction={handleAction} />);

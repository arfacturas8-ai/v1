...
describe('ActivityTimeline', () => {
  ...
  describe('Rendering', () => {
    ...
    it('handles loading state', () => {
      render(<ActivityTimeline {...defaultProps} loading={true} />);
      // Check for loading indicators
    });

    it('handles error state', () => {
      const error = 'Test error';
      render(<ActivityTimeline {...defaultProps} error={error} />);
  ...
  describe('User Interactions', () => {
    it('handles user interactions', async () => {
      ...
      render(<ActivityTimeline {...defaultProps} onAction={handleAction} />);
  ...
  describe('Edge Cases', () => {
    it('handles null/undefined props gracefully', () => {
      ...
      expect(() => render(<ActivityTimeline />)).not.toThrow();
    });
  });
});

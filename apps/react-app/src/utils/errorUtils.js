/**
 * Error Utilities
 * Ensures error messages are always strings for safe React rendering
 */

/**
 * Converts any error value to a safe string for rendering
 * Prevents React Error #130 (rendering objects directly)
 *

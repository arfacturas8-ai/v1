...
const initialList: ListFormData = {
  name: 'Web3 Builders',
...
export default function EditListPage() {
  ...
  const [formData, setFormData] = useState<ListFormData>(initialList);
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: colors.bg.primary }}>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '24px',
              border: 'none',
              backgroundColor: canSave && hasChanges && !isSaving ? colors.brand.primary : colors.bg.tertiary,
              color: canSave && hasChanges && !isSaving ? 'white' : colors.text.tertiary,
              fontSize: typography.fontSize.sm,
              fontWeight: typography.fontWeight.semibold,
              cursor: canSave && hasChanges && !isSaving ? 'pointer' : 'not-allowed',
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto', padding: spacing[4] }}>
        ...
        {/* Delete list */}
        <div style={{ paddingTop: spacing[4], borderTop: `1px solid ${colors.border.default}` }}>
          <button
            ...
            style={{
              ...
              padding: spacing[4],
              borderRadius: '12px',
              border: `2px solid ${showDeleteConfirm ? colors.semantic.error : colors.border.default}`,
              backgroundColor: showDeleteConfirm ? colors.semantic.error + '10' : colors.bg.secondary,
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = showDeleteConfirm ? colors.semantic.error + '10' : colors.bg.secondary;
            }}
          >
            <Trash2 size={20} />
            {showDeleteConfirm ? 'Click again to confirm deletion' : 'Delete this list'}
          </button>
          {showDeleteConfirm && (
            <p
              style={{

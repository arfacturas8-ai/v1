      ...
      <div className="bg-[#161b22]/80 backdrop-blur-xl border-b border-white/10 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-2 bg-[#161b22]/60 backdrop-blur-xl hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg text-sm text-white flex items-center gap-2 transition-all duration-200 touch-target"
              ...
              <button
                ...
                className={`
                  ...
                  ${filter === filterType
                    ...
                    : 'bg-[#161b22]/60 backdrop-blur-xl text-[#8b949e] hover:bg-white/10 hover:text-[#c9d1d9]'
                  }
                `}
          ...
          {selectedNotifications.size > 0 && (
            <div className="mt-3 p-3 bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-xl shadow-lg flex items-center justify-between">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6" ref={containerRef}>
        ...
        {loading ? (
          ...
          <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-8 text-center" role="status">
            ...
            <p className="text-[#c9d1d9] mb-6">Please sign in to view your notifications</p>
            <button
          ...
          <div className="space-y-3">
            {filteredNotifications.map((notification) => (
              <div
                key={notification.id}
                className={`
                  bg-[#161b22]/60 backdrop-blur-xl border rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 transition-all duration-200 hover:bg-[#1c2128]/80 hover:border-white/20 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)]
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    {!notification.isRead && (
                      <div className="absolute -top-0.5 -right-0.5 w-3 h-3 bg-[#58a6ff] rounded-full border-2 border-[#0d1117] shadow-[0_0_8px_rgba(88,166,255,0.6)]" aria-hidden="true"></div>
                    )}
                  </div>
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`font-semibold ${!notification.isRead ? 'text-white' : 'text-[#c9d1d9]'}`}>
                          {notification.title}
                        </span>
                      </div>
                      <span className="text-xs text-[#8b949e] whitespace-nowrap font-medium">
                        {formatDistanceToNow(notification.timestamp, { addSuffix: true })}
                      </span>
                    </div>
                    <p className={`text-sm ${!notification.isRead ? 'text-[#c9d1d9]' : 'text-[#8b949e]'}`}>{notification.content}</p>
                  </div>
      ...
      {notifications.length > 0 && (
        <div className="max-w-4xl mx-auto px-4 pb-6">
          <button
            ...
            className="w-full px-4 py-3 bg-[#161b22]/60 backdrop-blur-xl border border-red-500/20 hover:border-red-500/40 hover:bg-red-500/5 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] text-red-500 font-medium flex items-center justify-center gap-2 transition-all duration-200 touch-target"

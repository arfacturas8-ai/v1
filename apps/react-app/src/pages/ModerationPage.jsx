...
export default function ModerationPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0d1117] flex items-center justify-center" role="main" aria-label="Moderation page">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#58a6ff] mx-auto mb-4"></div>
          <p className="text-[#8b949e]">Loading moderation dashboard...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-[#0d1117]" role="main" aria-label="Moderation page">
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-center">
            ...
            <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] overflow-hidden">
              ...
              {reports.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-[#8b949e]">All clear! No pending reports at this time.</p>
                </div>
              ) : (
                    ...
                    <div key={report.id} className="p-4 hover:bg-[#21262d]/50 transition-colors">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-[#21262d] border border-white/10 hover:bg-[#30363d] text-white text-sm rounded-lg transition-colors disabled:opacity-50"
                          disabled={processingReport === report.id}
            ...
            <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-6">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full px-4 py-3 bg-[#21262d] border border-white/10 hover:bg-[#30363d] text-white rounded-lg font-medium transition-all text-left flex items-center justify-between group"

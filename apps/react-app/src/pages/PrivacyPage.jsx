    ...
    <div className="flex min-h-screen bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] relative">
      ...
      <aside className="hidden md:block w-[280px] sticky top-[80px] h-[calc(100vh-80px)] overflow-y-auto p-10 px-5 border-r border-black/10">
        <div className="sticky top-5">
          <h2 className="text-xs font-semibold text-[var(--color-text-tertiary)] uppercase tracking-wide mb-5">Contents</h2>
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-10 pb-20 md:px-5 md:py-10 md:pb-20">
        ...
        <section id="data-collection" className="mb-6">
          <div className="bg-[var(--color-bg-secondary)]/60  border border-black/10 rounded-xl p-5 md:p-6 shadow-[0_4px_16px_rgba(0,0,0,0.05)]">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Register for an account</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Create or modify your profile</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Post content, comments, or messages</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Join or create communities</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Connect your crypto wallet</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Contact our support team</li>
            </ul>

            <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mt-6 mb-3">Automatically Collected Information</h3>
            <p className="text-base leading-relaxed text-[var(--color-text-primary)] mb-4">When you access our services, we automatically collect certain information, including:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Device information (IP address, browser type, operating system)</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Usage data (pages visited, time spent, features used)</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Location data (with your permission)</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Cookies and similar tracking technologies</li>
            </ul>

            <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mt-6 mb-3">Blockchain Data</h3>
            <p className="text-base leading-relaxed text-[var(--color-text-primary)] mb-4">
        ...
        <section id="data-usage" className="mb-6">
          <div className="bg-[var(--color-bg-secondary)]/60  border border-black/10 rounded-xl p-5 md:p-6 shadow-[0_4px_16px_rgba(0,0,0,0.05)]">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Personalize your experience and content recommendations</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Process transactions and send related information</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Send you technical notices, updates, and security alerts</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Respond to your comments, questions, and support requests</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Monitor and analyze trends, usage, and activities</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Detect, prevent, and address technical issues and abuse</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Comply with legal obligations and enforce our terms</li>
            </ul>
          </div>
        </section>
        ...
        <section id="data-sharing" className="mb-6">
          <div className="bg-[var(--color-bg-secondary)]/60  border border-black/10 rounded-xl p-5 md:p-6 shadow-[0_4px_16px_rgba(0,0,0,0.05)]">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>With your consent:</strong> We may share your information when you give us permission</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Service providers:</strong> We share data with third-party vendors who help us operate our platform</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Business transfers:</strong> In connection with any merger, sale, or acquisition</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Legal requirements:</strong> To comply with laws, regulations, or legal processes</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Protection and safety:</strong> To protect the rights, property, and safety of Cryb.ai and our users</li>
            </ul>

            <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mt-6 mb-3">Public Information</h3>
            <p className="text-base leading-relaxed text-[var(--color-text-primary)] mb-4">
        ...
        <section id="your-rights" className="mb-6">
          <div className="bg-[var(--color-bg-secondary)]/60  border border-black/10 rounded-xl p-5 md:p-6 shadow-[0_4px_16px_rgba(0,0,0,0.05)]">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Correction:</strong> Update or correct inaccurate information</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Deletion:</strong> Request deletion of your account and data</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Portability:</strong> Receive your data in a structured, commonly used format</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Objection:</strong> Object to certain processing of your data</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Withdrawal:</strong> Withdraw consent at any time</li>
            </ul>
            <p className="text-base leading-relaxed text-[var(--color-text-primary)] mb-4">
        ...
        <section id="cookies" className="mb-6">
          <div className="bg-[var(--color-bg-secondary)]/60  border border-black/10 rounded-xl p-5 md:p-6 shadow-[0_4px_16px_rgba(0,0,0,0.05)]">
            ...
            <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mt-6 mb-3">Types of Cookies We Use</h3>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Essential cookies:</strong> Required for the platform to function properly</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Analytics cookies:</strong> Help us understand how users interact with our service</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Preference cookies:</strong> Remember your settings and preferences</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]"><strong>Marketing cookies:</strong> Track visitors across websites to display relevant ads</li>
            </ul>
          </div>
        </section>
        ...
        <section id="security" className="mb-6">
          <div className="bg-[var(--color-bg-secondary)]/60  border border-black/10 rounded-xl p-5 md:p-6 shadow-[0_4px_16px_rgba(0,0,0,0.05)]">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Encryption of data in transit and at rest</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Regular security assessments and audits</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Access controls and authentication mechanisms</li>
              <li className="text-base leading-relaxed text-[var(--color-text-primary)]">Employee training on data protection</li>
            </ul>
            <p className="text-base leading-relaxed text-[var(--color-text-primary)] mb-4">

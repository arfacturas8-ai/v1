...
const AccountSuspendedPage = () => {
  return (
    <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9] flex items-center justify-center p-5 md:p-10" role="main" aria-label="Account suspended page">
      <div className="max-w-2xl w-full bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-xl p-8 md:p-12 shadow-2xl text-center" role="alert" aria-live="polite">
        ...
        <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg mb-8 text-left">
          ...
          <p className="text-sm text-[#c9d1d9] m-0">Multiple reports of spam and inappropriate content.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button className="flex-1 min-w-[140px] px-6 py-3 bg-transparent border border-white/10 rounded-lg text-[#c9d1d9] text-base font-medium cursor-pointer transition-all hover:bg-[#161b22]/60 backdrop-blur-xl flex items-center justify-center gap-2" aria-label="Appeal account suspension">

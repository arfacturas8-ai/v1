                ...
                {item.toggle ? (
                  <div className="card flex items-center justify-between p-3 md:p-4 hover:  transition-colors">
                    <div className="flex items-center gap-3 md:gap-4">
                      <div className="w-9 md:w-10 h-9 md:h-10 rounded-lg flex items-center justify-center bg-[#FFFFFF]">
                        <item.icon className="w-4 md:w-5 h-4 md:h-5 text-[#000000]" />
                      </div>
                      <div>
                    ...
                    <button
                      ...
                      className={`relative w-11 md:w-12 h-5 md:h-6 rounded-full transition-colors border border-white/10 ${twoFactor ? 'bg-[#000000]' : 'bg-[#FFFFFF]'}`}

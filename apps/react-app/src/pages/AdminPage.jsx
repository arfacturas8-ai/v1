...
function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117]" role="main" aria-label="Admin dashboard page">
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6 hover:border-white/10 transition-all">
            ...
            <h3 className="text-[#c9d1d9] font-medium mb-1 text-sm sm:text-base">Total Users</h3>
            <p className="text-[#8b949e] text-xs sm:text-sm">+12% from last month</p>
          </div>
          ...
          <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6 hover:border-white/10 transition-all">
            ...
            <h3 className="text-[#c9d1d9] font-medium mb-1 text-sm sm:text-base">Communities</h3>
            <p className="text-[#8b949e] text-xs sm:text-sm">+8 new this week</p>
          </div>
          ...
          <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6 hover:border-white/10 transition-all">
            ...
            <h3 className="text-[#c9d1d9] font-medium mb-1 text-sm sm:text-base">Total Posts</h3>
            <p className="text-[#8b949e] text-xs sm:text-sm">+234 today</p>
          </div>
          ...
          <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6 hover:border-white/10 transition-all">
            ...
            <h3 className="text-[#c9d1d9] font-medium mb-1 text-sm sm:text-base">Pending Reports</h3>
            <p className="text-[#8b949e] text-xs sm:text-sm">Requires attention</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="lg:col-span-2">
            <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <button className="flex items-center gap-3 p-3.5 sm:p-4 bg-[#21262d]/60 hover:bg-[#21262d] border border-white/10 rounded-lg transition-all group min-h-[44px]">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <p className="text-white font-medium group-hover:text-[#58a6ff] transition-colors text-sm sm:text-base">Manage Users</p>
                    <p className="text-[#8b949e] text-xs sm:text-sm truncate">View and manage all users</p>
                  </div>
                  <svg className="w-5 h-5 text-[#8b949e] group-hover:text-white group-hover:translate-x-1 transition-all shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button className="flex items-center gap-3 p-3.5 sm:p-4 bg-[#21262d]/60 hover:bg-[#21262d] border border-white/10 rounded-lg transition-all group min-h-[44px]">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <p className="text-white font-medium group-hover:text-emerald-400 transition-colors text-sm sm:text-base">Communities</p>
                    <p className="text-[#8b949e] text-xs sm:text-sm truncate">Manage communities</p>
                  </div>
                  <svg className="w-5 h-5 text-[#8b949e] group-hover:text-white group-hover:translate-x-1 transition-all shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                ...
                <button className="flex items-center gap-3 p-3.5 sm:p-4 bg-[#21262d]/60 hover:bg-[#21262d] border border-white/10 rounded-lg transition-all group min-h-[44px]">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <p className="text-white font-medium group-hover:text-red-400 transition-colors text-sm sm:text-base">Moderation</p>
                    <p className="text-[#8b949e] text-xs sm:text-sm truncate">Review reports & flags</p>
                  </div>
                  <svg className="w-5 h-5 text-[#8b949e] group-hover:text-white group-hover:translate-x-1 transition-all shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                ...
                <button className="flex items-center gap-3 p-3.5 sm:p-4 bg-[#21262d]/60 hover:bg-[#21262d] border border-white/10 rounded-lg transition-all group min-h-[44px]">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <p className="text-white font-medium group-hover:text-amber-400 transition-colors text-sm sm:text-base">Settings</p>
                    <p className="text-[#8b949e] text-xs sm:text-sm truncate">Platform configuration</p>
                  </div>
                  <svg className="w-5 h-5 text-[#8b949e] group-hover:text-white group-hover:translate-x-1 transition-all shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-[#161b22]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4">System Health</h3>
                ...
                {[
                  ...
                  <div key={index} className="flex items-center gap-2.5 sm:gap-3 text-xs sm:text-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-white truncate">{item.action}</p>
        ...
        {/* Additional Info */}
        <div className="bg-gradient-to-r from-[#58a6ff]/10 via-[#a371f7]/10 to-[#58a6ff]/10 border border-[#58a6ff]/30 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6 text-center backdrop-blur-xl">
          <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Full Admin Panel Coming Soon</h3>
          <p className="text-[#c9d1d9] mb-3 sm:mb-4 text-sm sm:text-base">
            Advanced analytics, detailed reporting, and more powerful tools are being developed.
          </p>
          <button className="px-5 sm:px-6 py-2.5 sm:py-2 bg-gradient-to-r from-[#58a6ff] to-[#a371f7] text-white rounded-lg font-medium hover:opacity-90 transition-all text-sm sm:text-base min-h-[44px]">
            View Roadmap
          </button>
        </div>
      </div>

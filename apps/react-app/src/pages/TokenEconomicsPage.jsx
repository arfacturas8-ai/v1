...
function TokenEconomicsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0b0d] to-[#1a1b1f] p-4 sm:p-6 lg:p-8 text-white">
      {/* Page Header */}
      <div className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">Token Economics</h1>
            <p className="text-sm sm:text-base text-white/70">Manage your CRYB tokens and participate in governance</p>
          </div>
          {!state.isConnected ? (
            <button
              className="btn-primary-gradient flex items-center gap-2 px-4 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base whitespace-nowrap"
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <div className="bg-[#161b22]/60 backdrop-blur-xl px-3 py-2 rounded-lg text-sm font-mono">
                {state.account?.slice(0, 6)}...{state.account?.slice(-4)}
              </div>
              <button
                className="btn-secondary-dark px-3 py-2 sm:px-4 sm:py-2.5 text-sm whitespace-nowrap"
      ...
      {/* Message Toast */}
      {message && (
        <div className={`fixed top-4 right-4 z-50 px-6 py-3 rounded-lg shadow-lg backdrop-blur-sm transition-all ${
      ...
      {!state.isConnected && (
        <div className="flex flex-col items-center justify-center py-12 sm:py-16 lg:py-24 px-4 text-center">
          <Wallet size={isMobile ? 48 : 64} className="text-white/30 mb-6" />
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Connect Your Wallet</h2>
          ...
          <div className="mt-8">
            <span className="text-sm text-white/50 block mb-3">Supported wallets:</span>
            <div className="flex flex-wrap gap-3 justify-center text-sm">
              <span className="bg-[#161b22]/60 backdrop-blur-xl px-3 py-1.5 rounded-lg">MetaMask</span>
              <span className="bg-[#161b22]/60 backdrop-blur-xl px-3 py-1.5 rounded-lg">Coinbase</span>
              <span className="bg-[#161b22]/60 backdrop-blur-xl px-3 py-1.5 rounded-lg">WalletConnect</span>
            </div>
          </div>
        </div>
      )}
